...
class Challenge60 extends StatefulWidget {
  const Challenge60({super.key});

  @override
  State<Challenge60> createState() => _Challenge60State();
}

class _Challenge60State extends State<Challenge60> {
  // Generate a list for a 60-day challenge
  final List<bool> _dayCompletionStatus = List.generate(60, (index) => index < 10); // Example: First 10 days completed
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('60-Day Challenge', style: TextStyle(color: Colors.white)),
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Push your limits over 60 days to build serious momentum and see remarkable changes in your strength and stamina.',
                  style: TextStyle(
